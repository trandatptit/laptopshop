                            ...
                            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                <form action="login" method="post">
                                    <div class="card-body p-5 text-center">
                                        ...
                                        <div>
                                            <button class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" style="width: 100%" type="submit">Đăng nhập</button>
                                        </div>
                                        ...
                                        <div class="signup_link">
                                            Bạn quên mật khẩu?<a href="forgotPassword">Đặt lại tại đây</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
