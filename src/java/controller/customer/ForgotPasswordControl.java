...
public class ForgotPasswordControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isEmailAsscociated = nguoiDungDao.isEmailAssociated(email);
            ...
            if (email != null || !email.equals("")) {
                ...
                Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(usernanme, password);// Put your email
                        // id and
                        // password here
                    }
                });
                ...
                mySession.setAttribute("otpTime", System.currentTimeMillis()); // Lưu thời gian hiện tại
