                                    ...
                                    <div class="pt-3 pb-3">
                                        <form class="form-horizontal" action="newPassword" method="post">
                                            ...
                                            <div class="form-outline mb-4" id="show_hide_password2">  
                                                <input type="password" name="confPassword" placeholder="Confirm New Password" class="form-control form-control-lg" required/>
                                                <div class="input-group-addon">                                                 
                                                    <a href=""><i class="fas fa-eye-slash"></i></a>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Reset Button -->
                                            <div>
                                                <button class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" style="width: 100%" type="submit">Reset</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
