...
<html>
    ...
    <body>
        ...
        %>
        <%
            String status = (String) session.getAttribute("messageBuy");
            if (status != null) {
        %>
        <script>
        ...
        <%
            ...
            session.removeAttribute("messageBuy");            
        %>
        <!-- header -->
        <header id="header">
            <div class="container">
                                ...
                                <div class="preview col-md-6">
                                    <div class="preview-pic tab-content">
                                        ...
                                        <c:forEach items="${requestScope.hinhanhsp}" var="i" varStatus="loop">
                                            <div class="tab-pane ${loop.first ? '' : 'fade'}" id="pic-${loop.index}">
                                ...
                                <div class="details col-md-6">
                                    ...
                                    <p class="product-description">${sanpham.moTaNgan}</p>
                                            <small class="text-muted">Giá cũ: <s><span>
                                                        <fmt:formatNumber value="${sanpham.giaBan + sanpham.giaBan * 0.1}" type="currency" currencyCode="VND" var="formattedPrice" pattern="#,##0" />
                                    ...
                                    <div class="form-group">
                                        <label for="soluong">(Số lượng mỗi lần thêm vào giỏ hàng là 1 sản phẩm)</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table table-bordered">
                                    ...
                                    <td>${thongso.ssd}</td>
                                    <td>${thongso.card}</td>
                                    <td>${thongso.congKetNoi}</td>
                                    <td>${thongso.manHinh}</td>
                                    <td>${thongso.heDieuHanh}</td>
                                    <td>${thongso.thoiDiemRaMat}</td>
                                    </tbody>
